...
COPY dist/all-my-saints-website-*.tar.gz ./app.tar.gz
...
CMD python3 ./manage.py collectstatic --no-input && python3 ./manage.py migrate && gunicorn -c gunicorn.py all_my_saints.wsgi
